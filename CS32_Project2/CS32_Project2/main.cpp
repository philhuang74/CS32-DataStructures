...
//TEST if Empty m1, m2, result should be empty and TRUE.
//    Map m1;
//    Map m2;
//    m1.insert("Lucy",79);
//    Map result = m1;
...
//Testing if m size = 1 works for reassign
//    Map m;
//    m.insert("Lucy",12);
//    Map result;
//    result = m;
...
//Check with type aliasing the result is a different map for reassign PASSED
//    Map m;
//    m.insert("Pedro",12);
//    m.insert("Joe",15);
//    Map& result = m;
...
////Check with type aliasing for merge
//    Map m;
//    m.insert("Pedro",12);
//    m.insert("Joe",15);
//    Map& m2 = m;
...
//     Tests that copy constructor creates a Map at different address with same values
//        Map m;
//        m.insert("Pedro",12);
//        Map temp(m);
//        cerr << "&m: " << &m;
...
//Check if reassignment works when m and result are at different addresses
//    Map m;
//    m.insert("Fred",123);
//    m.insert("Ethel",456);
//    m.insert("Lucy",789);
